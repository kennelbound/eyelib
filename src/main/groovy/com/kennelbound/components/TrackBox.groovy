...
class TrackBox extends Pane implements IGazeListener {
    ...
    TrackBox() {
        ...
        trackingLost = createImageView("/images/trackinglost.png");
        trackingLost.visible = true;

        successOverlay = createImageView("/images/gradient_green_128.png");
        successOverlay.visible = false;
        successOverlay.x = 0;
        successOverlay.y = 0;

        failureOverlay = createImageView("/images/gradient_red_128.png");
        failureOverlay.x = 0;
        failureOverlay.y = 0;
    ...
    ImageView createEye() {
        ImageView imageView = createImageView("/images/tb_eye_128.png")
